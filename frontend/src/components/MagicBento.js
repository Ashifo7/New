...
const MagicBento = ({
  ...
  cardData // Custom prop to accept an array of card data
}) => {
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData?.map((card, index) => { // Defensive check for cardData
              ...
              return (
                <ParticleCard
                  ...
                  style={{
                    ...
                    backgroundImage: `linear-gradient(to bottom, transparent, transparent), radial-gradient(circle at center, rgba(147, 51, 234, 0.1), rgba(59, 130, 246, 0.1), transparent)`,
